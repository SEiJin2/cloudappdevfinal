...
# The views are required for the API to work.
# The viewsets are used to define the view behavior of the API.
# The viewsets are used to define the CRUD operations for the models.
